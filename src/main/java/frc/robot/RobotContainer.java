...
public class RobotContainer {
  ...
  private void configureSysid() {
    ...
    controllers.driver.povUp().whileTrue(drivetrain.sysIdDynamic(Direction.kForward));
    controllers.driver.povDown().whileTrue(drivetrain.sysIdDynamic(Direction.kReverse));
    controllers.driver.povLeft().whileTrue(drivetrain.sysIdQuasistatic(Direction.kForward));
    controllers.driver.povRight().whileTrue(drivetrain.sysIdQuasistatic(Direction.kReverse));
  }
